...
export const defaultJfifToPngSettings = {
  quality: 100, // number — ImageMagick quality (0–100)
};

const JfifToPngSetting = ({ isOpen, onClose, file, onSave }) => {
  return (
    <ImageSettingsModal
      isOpen={isOpen}
      onClose={onClose}
...
const ImageSettingsModal = ({ file, isOpen, onClose, onSave }) => {
  const [settings, setSettings] = useState(defaultJfifToPngSettings);
  ...
  const handleReset = () => setSettings(defaultJfifToPngSettings);
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl">
        ...
        <div className="p-6 space-y-6 max-h-[65vh] overflow-y-auto">
          ...
          <div className="flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg px-4 py-2">
            ...
            <span className="text-xs text-blue-500 dark:text-blue-400">— JFIF to PNG conversion</span>
          </div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 rounded-lg px-4 py-3">
            PNG is lossless by nature. Quality 100 is recommended for best results.
          </p>
        </div>
...
export default JfifToPngSetting;