...
// backgroundColor and colorSpace were silently ignored by the backend.
export const defaultWebpToJpgSettings = {
  quality: 90, // number — ImageMagick quality (0–100)
};

const WebpToJpgSetting = ({ isOpen, onClose, file, onSave }) => {
  return (
    <ImageSettingsModal
      isOpen={isOpen}
      onClose={onClose}
...
const ImageSettingsModal = ({ file, isOpen, onClose, onSave }) => {
  const [settings, setSettings] = useState(defaultWebpToJpgSettings);
  ...
  const handleReset = () => setSettings(defaultWebpToJpgSettings);
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl">
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">JPG Options</h3>
          </div>
        ...
        <div className="p-6 space-y-6 max-h-[65vh] overflow-y-auto">
          ...
          <div className="flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg px-4 py-2">
            ...
            <span className="text-xs text-blue-500 dark:text-blue-400">— transparent areas will be filled with white</span>
          </div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 rounded-lg px-4 py-3">
            JPG does not support transparency. Any transparent areas in the source file will appear white in the output.
          </p>
        </div>
...
export default WebpToJpgSetting;